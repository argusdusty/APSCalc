...
public class REchelon extends UnivarFunction
{

	public REchelon(Expression arg1)
	{
		this.arg1 = arg1;
		this.name = "echelon";
	}
	...
	public Expression substitute(Variable x, Expression e) {return new REchelon(arg1.substitute(x, e)).simplify();}
	public Expression copy() {return new REchelon(arg1);}
}
